      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-background dark:bg-gray-900 px-4">
          <div className="max-w-md w-full text-center">
            <div className="mb-8">
              <div className="w-24 h-24 mx-auto bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center mb-4">
                <svg
              ...
              <button
                ...
                className="bg-blue-9 dark:bg-purple-9 text-white px-6 py-3 rounded-lg hover:bg-blue-10 dark:hover:bg-purple-10 transition-colors"
              >
                Recargar página
              </button>
            </div>
